	  ...
	  init: function () {
		...
		*/
		...
		this.on("success", function(file) {
		    ...
		    var videos = ['uploads/thanosMovie.mp4', 'uploads/1x1.mp4', 'uploads/916.mp4', 'uploads/4x5.mp4'];
		    if(location.hostname == 'localhost') {
		    	videos = ['uploads/thanosMovie.mp4', 'uploads/1x1.mp4', 'uploads/916.mp4', 'uploads/4x5.mp4'];
		    }
